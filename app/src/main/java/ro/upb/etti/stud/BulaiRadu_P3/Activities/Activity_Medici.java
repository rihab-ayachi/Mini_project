...
public class Activity_Medici extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mediciList.addAll(db.getAllMedici("Nom"));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.idmenu_medici_sort2:
                //SORTARE MEDICI (de fapt stergere si reafisare lista...)
                mediciList.clear();
                mediciList.addAll(db.getAllMedici("specialité"));
                mAdapter.notifyDataSetChanged();
                return true;
        }
    ...
    private void showMediciEditDialog(final boolean shouldUpdate, final Medici medic, final int position) {
        ...
        AlertDialog.Builder alertDialogBuilderUserInput = new AlertDialog.Builder(Activity_Medici.this);
        ...
        dialogTitle.setText(!shouldUpdate ? "Ajouter un nouveau médecin" : "Edit Medicine");
        ...
        alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(inputNume.getText().toString()) || TextUtils.isEmpty(inputPrenume.getText().toString())) {
                    Toast.makeText(Activity_Medici.this,
                            "Remplissez le nom et le prénom du médecin!", Toast.LENGTH_SHORT).show();
                    return;
                } else {
                    alertDialog.dismiss();
                }
