        ...
        register_button_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (user.isEmpty() || pwd.isEmpty() || pwd_conf.isEmpty()) {
                    Toast.makeText(Activity_Register.this, "Remplissez tous les champs !", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (pwd.equals(pwd_conf)) {
                    ...
                    if (val > 0) {
                        Toast.makeText(Activity_Register.this, "Enregistré avec succès!", Toast.LENGTH_SHORT).show();
                        Intent moveToLogin = new Intent(Activity_Register.this, Activity_Login.class);
                        startActivity(moveToLogin);

                    } else {
                        Toast.makeText(Activity_Register.this, "Enregistré non succès.", Toast.LENGTH_SHORT).show();
                    }

                } else {
                    Toast.makeText(Activity_Register.this, "Les mots ne correspondent pas !", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
