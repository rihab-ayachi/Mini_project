...
public class Adapter_Consultatie extends RecyclerView.Adapter<Adapter_Consultatie.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.listrow_diagnostic.setText("Diagnostique " + consultatii.getDiagnostic());
        holder.listrow_doza.setText("Doze: " + Float.toString(consultatii.getDozamedicament()) + " mg");

        holder.listrow_afisare_medicament.setText("Médicament recommandé: " + consultatii.getDenumireMedicament());
        holder.listrow_afisare_pacient.setText("Pacient: " + consultatii.getNumePacient() + " " + consultatii.getPrenumePacient());
        holder.listrow_afisare_medic.setText("Medicine: Dr. " + consultatii.getNumeMedic() + " " + consultatii.getPrenumeMedic());
    }
