...
public class Activity_Sectii extends AppCompatActivity {
    ...
    public void showSectiiEditDialog(final boolean shouldUpdate, final Sectii sectie, final int position) {
        ...
        AlertDialog.Builder alertDialogBuilderUserInput = new AlertDialog.Builder(Activity_Sectii.this);
        ...
        dialogTitle.setText(!shouldUpdate ? "Ajouter un nouvel service" : "Edit service");

        // Pentru optiunea de update, voi lua datele dinainte si le voi pune in casutele EditText
        ...
        // imi construiesc alert dialog-ul
        ...
        alertDialog.show(); //afisez alert dialog
        ...
        alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                        Toast.makeText(Activity_Sectii.this,
                                "Remplisserz l'id, le nom et le facture service !", Toast.LENGTH_SHORT).show();
                        return;
                }
                ...
                if (!(lista_ids_pacienti.contains(Integer.valueOf(input_id_pacient.getText().toString())) &&
                        ...
                        Toast.makeText(Activity_Sectii.this,
                                "Id-saisie est introuvable", Toast.LENGTH_SHORT).show();
                        return;
                } else {
                    alertDialog.dismiss();
                } //
