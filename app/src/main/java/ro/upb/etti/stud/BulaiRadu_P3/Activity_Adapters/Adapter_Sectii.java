...
public class Adapter_Sectii extends RecyclerView.Adapter<Adapter_Sectii.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.listrow_nume.setText("NonService: " + sectie.getNume());
        holder.listrow_buget.setText("Facture: " + Float.toString(sectie.getBuget()));

        holder.listrow_afisare_medic.setText("Médicament attribué: Dr. " + sectie.getNumeMedic() + " " + sectie.getPrenumeMedic());
        holder.listrow_afisare_pacient.setText("Patient affecté: " + sectie.getNumePacient() + " " + sectie.getPrenumePacient());
