...
public class Activity_Consultatii_Client extends AppCompatActivity {
    ...
    public void showConsultatiiEditDialog(final boolean shouldUpdate, final Consultatii consultatie, final int position) {
        ...
        AlertDialog.Builder alertDialogBuilderUserInput = new AlertDialog.Builder(Activity_Consultatii_Client.this);
        ...
        dialogTitle.setText(!shouldUpdate ? "Ajouter une consultation" : "Edit consultation");
        ...
        alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(Activity_Consultatii_Client.this,
                            "Remplissez l'id, la dose (mg) et le nom du diagnostic !", Toast.LENGTH_SHORT).show();
                    return;
                }
