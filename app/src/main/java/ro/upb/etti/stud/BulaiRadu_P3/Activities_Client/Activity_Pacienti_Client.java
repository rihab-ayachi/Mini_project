...
public class Activity_Pacienti_Client extends AppCompatActivity{
    ...
    public void showPacientiEditDialog(final boolean shouldUpdate, final Pacienti pacient, final int position) {
        ...
        AlertDialog.Builder alertDialogBuilderUserInput = new AlertDialog.Builder(Activity_Pacienti_Client.this);
        ...
        dialogTitle.setText(!shouldUpdate ? "Ajouter un nouvel pacient" : "Edit pacient");
        ...
        alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(inputCnp.getText().toString()) ||
                    ...
                    Toast.makeText(Activity_Pacienti_Client.this,
                            "Renseignez le CNP, le nom et le prénom du patient !", Toast.LENGTH_SHORT).show();
                    return;
                } else {
                    alertDialog.dismiss();
                }
