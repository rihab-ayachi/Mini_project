...
public class Activity_Medicamente extends AppCompatActivity {
    ...
    public void showMedicamenteEditDialog(final boolean shouldUpdate, final Medicamente medicament, final int position) {
        ...
        AlertDialog.Builder alertDialogBuilderUserInput = new AlertDialog.Builder(Activity_Medicamente.this);
        alertDialogBuilderUserInput.setView(view);

        final EditText inputDenumire = view.findViewById(R.id.iddialog_medicament);
        ...
        alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(inputDenumire.getText().toString())) {
                    ...
                    Toast.makeText(Activity_Medicamente.this,
